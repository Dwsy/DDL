package link.dwsy.ddl.util.anchorlink;

import com.vladsch.flexmark.html.HtmlRenderer;
import com.vladsch.flexmark.parser.Parser;
import com.vladsch.flexmark.util.data.DataKey;
import com.vladsch.flexmark.util.data.MutableDataHolder;
import link.dwsy.ddl.util.anchorlink.internal.AnchorLinkNodePostProcessor;
import link.dwsy.ddl.util.anchorlink.internal.AnchorLinkNodeRenderer;
 ...
 */
public class MyAnchorLinkExtension implements Parser.ParserExtension, HtmlRenderer.HtmlRendererExtension {
    ...
    private MyAnchorLinkExtension() {
    }

    public static MyAnchorLinkExtension create() {
        return new MyAnchorLinkExtension();
    }
