...
//        addCollectionToGroup(3, 1, 1, CollectionType.Answer);
    ...
    public void addCollectionToGroup(long uid, long gid, long sid, CollectionType collectionType) {
        if(userCollectionRepository.existsByUserIdAndSourceIdAndCollectionTypeAndDeletedFalse(uid, sid, collectionType)) {
            throw new CodeException(CustomerErrorCode.CollectionAlreadyExist);
        }
